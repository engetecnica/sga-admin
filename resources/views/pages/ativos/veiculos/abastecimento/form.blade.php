        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    @php
                        $action = isset($store->abastecimento) ? route('ativo.veiculo.abastecimento.update', $store->id) : route('ativo.veiculo.abastecimento.store', $store->id);
                    @endphp
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="combustivel" id="combustivel" class="form-select">
                                    <option value="" @if (!isset($store->abastecimento) || !$store->abastecimento->combustivel) selected @endif>Selecione
                                    </option>

                                    <option value="etanol_alcool" @if (isset($store->abastecimento) && $store->abastecimento->combustivel == 'etanol_alcool') selected @endif>
                                        Etanol/Alcool</option>
                                    <option value="gasolina" @if (isset($store->abastecimento) && $store->abastecimento->combustivel == 'gasolina') selected @endif>Gasolina
                                    </option>
                                    <option value="diesel" @if (isset($store->abastecimento) && $store->abastecimento->combustivel == 'diesel') selected @endif>Diesel</option>
                                    <option value="gnv" @if (isset($store->abastecimento) && $store->abastecimento->combustivel == 'gnv') selected @endif>GNV</option>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-4">
                                ...
                                <input type="number" step="any" class="form-control" id="quilometragem"
                                    value="{{ old('quilometragem', @$store->abastecimento->quilometragem) }}"
                                    name="quilometragem">
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control" id="quantidade"
                                    value="{{ old('quantidade', @$store->abastecimento->quantidade) }}" name="quantidade">
                            </div>
                            <div class="col-md-4">
