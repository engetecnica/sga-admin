                            ...
                            @foreach ($fornecedores as $fornecedor)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="excluir-padrao" data-id="{{ $fornecedor->id }}" data-table="fornecedors" data-module="cadastro/fornecedor" data-redirect="{{ route('fornecedor') }}" href="javascript:void(0)">
