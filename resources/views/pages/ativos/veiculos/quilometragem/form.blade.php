        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    @php
                        $action = isset($store->quilometragem) ? route('ativo.veiculo.quilometragem.update', $store->id) : route('ativo.veiculo.quilometragem.store', $store->id);
                    @endphp
                        ...
                        <div class="row  mt-3">
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control" id="quilometragem_nova"
                                    value="{{ old('quilometragem_nova', @$store->quilometragem->quilometragem_nova) }}"
