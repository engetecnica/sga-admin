...
<div class="page-header">
    <h3 class="page-title">
        ...
        </span> Cadastro de Empresa / Líder
    </h3>
    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                @php $action = isset($store) ? url('cadastro/empresa/update/'.$store->id) : url('cadastro/empresa/store'); @endphp
