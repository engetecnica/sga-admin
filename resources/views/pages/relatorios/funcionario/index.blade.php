        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('relatorio.funcionario.gerar') }}">
                        @csrf
                        <div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-4">
                                <label for="obra" class="form-label">Obras</label>
                                <select name="obra" id="obra" class="form-select">
                                    <option value="" selected>Selecione uma empresa primeiro</option>
                                </select>
                            </div>
                        </div>
            ...
            if (empresa_id) {
                $.ajax({
                    ...
                    success: function(data) {
                        $('#obra').empty();
                        $('#obra').append('<option value="">Selecione uma obra</option>');
                        $.each(data, function(key, value) {
                            $('#obra').append('<option value="' + key + '">' +
                                value + '</option>');
                        });
                    }
                });
                ...
                $('#obra').empty();
                $('#obra').append('<option value="">Selecione uma empresa primeiro</option>');
            }
        });
    });
</script>
