                        ...
                        @if ($ferramentalRequisicao->status > 1)
                            <table class="table-striped table">
                                ...
                                @foreach ($transferencias as $transferencia)
                                    <tr>
                                        <td>
                                            <span class="badge badge-secondary">{{ $transferencia->obraOrigem->codigo_obra }}</span> {{ $transferencia->obraOrigem->razao_social }}
                                        </td>
                                        <td>
                                            <span class="badge badge-secondary">{{ $transferencia->obraDestino->codigo_obra }}</span> {{ $transferencia->obraDestino->razao_social }}
                                        </td>
